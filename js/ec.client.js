...
EC.Client.prototype._onConnect = function(status) {
...
EC.Client.prototype._onConnected = function () {
    // get friend list
...
EC.Client.prototype._onPresenceChange = function (stanza) {
    stanza = $(stanza);
...
EC.Client.prototype._onMessage = function (stanza) {
    stanza = $(stanza);
...
EC.Client.prototype._onRoster = function (stanza) {
...
EC.Client.prototype._onRosterChange = function (stanza) {
    var message = this._handleRosterStanza(stanza);
...
EC.Client.prototype._handleRosterStanza = function (stanza) {
    var self = this,
...
EC.Client.prototype.connect = function () {
    this.connection.connect(this.jid, this.password, _.bind(this._onConnect, this));
    return this;
};

EC.Client.prototype.disconnect = function () {
    this.connection.flush();
    this.connection.disconnect();
    $.publish('disconnected.client.im');
};

EC.Client.prototype.send = function (stanza) {
    this.connection.send(stanza);
};

EC.Client.prototype.iq = function (stanza, error, success) {
    this.connection.sendIQ(stanza, success, error);
};

EC.Client.prototype.presence = function (status) {
    var stanza = $pres();
    if (status) {
...
EC.Client.prototype.message = function (to, message) {
...
EC.Client.prototype.getRoster = function (error, success) {
